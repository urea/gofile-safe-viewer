...
public class MainActivity2 extends Activity {
    ...
    private static final String[] ALLOWED_URL_TOKENS = {"gofile", "twimgga"};
    private static final String ALLOWED_RULE = "HTTPS かつURL文字列に gofile または twimgga を含むURL";
    private static final String RESOURCE_RULE = "追加リソース許可: *.fun800.click, *.twimg.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (initialUrl != null) {
            ...
            setStatus("URLを貼り付けるか、共有から開いてください。許可条件: " + ALLOWED_RULE + " / " + RESOURCE_RULE);
        }
    }
    ...
    private void configureWebView() {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                setStatus("自動ダウンロードを遮断しました。v0.7では保存機能は入れていません。");
            }
        });
    }
    ...
    private void buildUi() {
        ...
        urlInput.setHint("gofile / twimgga を含むHTTPS URL");
    ...
    private void toggleLimitedJavaScript() {
        ...
        settings.setDatabaseEnabled(limitedJavaScriptEnabled);
        jsButton.setText(limitedJavaScriptEnabled ? "制限付きJS: ON" : "制限付きJS: OFF");
        setStatus(limitedJavaScriptEnabled ? "JavaScriptを有効化しました。" : "JavaScriptを無効化しました。");
    ...
    private boolean isAllowedResourceUrl(Uri uri) {
        ...
        if (containsAllowedToken(uri.toString())) {
            return true;
        }
    ...
    private boolean containsAllowedToken(String value) {
        ...
        for (String token : ALLOWED_URL_TOKENS) {
    ...
    private void injectViewerMaxCss(boolean enabled) {
        if (webView == null) {
            return;
        }
        String script;
